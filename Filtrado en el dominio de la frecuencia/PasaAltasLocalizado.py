...
def Mask_PasaAlta(img_shift, vec, d1, d2, aux = 0):
...
mask = Mask_PasaAlta(img_sdft, P, r1, r2)
img_mask = img_sdft * mask
img_isdft = np.fft.ifftshift(img_mask)
img_filtrada = cv.idft(img_isdft)
img_filtrada = cv.magnitude (img_filtrada[:,:, 0], img_filtrada[:,:, 1])
...
r1, r2 = 7, 5
cv.namedWindow("Original")
cv.createTrackbar("Orden", "Original", 5, 10, CambiarOrdenButterworth)
cv.imshow("Original", img)
O = 5
img_dft = TransformarFourier(img)
img_sdft = np.fft.fftshift(img_dft)
...
img_dft = TransformarFourier(img)
img_sdft = np.fft.fftshift(img_dft)
mask = Mask_PasaAlta(img_sdft, P, r1, r2, 1)
img_mask = img_sdft * mask
img_isdft = np.fft.ifftshift(img_mask)
img_filtrada = cv.idft(img_isdft)
img_filtrada = cv.magnitude (img_filtrada[:,:, 0], img_filtrada[:,:, 1])
...
img_dft = TransformarFourier(img)
img_sdft = np.fft.fftshift(img_dft)
mask = Mask_PasaAlta(img_sdft, P, r1, r2, 2)
img_mask = img_sdft * mask
img_isdft = np.fft.ifftshift(img_mask)
img_filtrada = cv.idft(img_isdft)
img_filtrada = cv.magnitude (img_filtrada[:,:, 0], img_filtrada[:,:, 1])
...
img_dft = TransformarFourier(img)
img_sdft = np.fft.fftshift(img_dft)
mask = Mask_PasaAlta(img_sdft, P, r1, r2, 3)
img_mask = img_sdft * mask
img_isdft = np.fft.ifftshift(img_mask)
img_filtrada = cv.idft(img_isdft)
img_filtrada = cv.magnitude (img_filtrada[:,:, 0], img_filtrada[:,:, 1])
